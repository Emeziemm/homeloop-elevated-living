  ...
  notFoundComponent: () => (
    <div className="grid min-h-screen place-items-center bg-canvas px-6 text-center">
      <div>
        ...
        <Link to="/properties" search={{ location: undefined, type: undefined, beds: undefined, min: undefined, max: undefined }} className="mt-6 inline-block rounded-full bg-ink px-6 py-3 text-sm text-primary-foreground">Back to collection</Link>
      </div>
    </div>
  ),
});
    ...
    <section ref={ref} className="relative min-h-[96svh] w-full overflow-hidden bg-ink text-primary-foreground">
      ...
      <div className="relative z-10 mx-auto grid min-h-[96svh] max-w-[1400px] grid-cols-1 gap-8 px-6 pb-24 pt-32 lg:grid-cols-12 lg:px-10 lg:pb-32 lg:pt-36">
        <motion.nav initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease, delay: 0.2 }}
          ...
          <span>/</span>
          <Link to="/properties" search={{ location: undefined, type: undefined, beds: undefined, min: undefined, max: undefined }} className="hover:text-primary-foreground">Properties</Link>
          <span>/</span>
